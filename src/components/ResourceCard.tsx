...
export function ResourceCard({
  ...
  return (
    <div className="group rounded-xl border border-ink-800/10 bg-white p-4 transition-all hover:border-ink-800/20 hover:shadow-lg hover:shadow-ink-950/5">
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-start gap-2.5">
          ...
          <div>
            <h3 className="font-display text-[1.02rem] font-semibold leading-tight text-ink-950">
              {resource.name}
            </h3>
            <span
        ...
        {distanceKm !== undefined && (
          <span className="shrink-0 rounded-md bg-paper-100 px-2 py-0.5 font-mono text-[0.72rem] font-medium text-ash-600">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="mt-3 inline-flex items-center gap-1 text-[0.8rem] font-semibold text-accent-600 transition group-hover:gap-1.5"
      >
